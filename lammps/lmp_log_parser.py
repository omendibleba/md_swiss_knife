...
if args.ensemble == 'NVT':
    ...
    axs[0, 0].set_xlabel("Time (ns)",fontsize=16 , fontweight='bold')
    ...
    axs[0, 1].set_xlabel("Time (ns)",fontsize=16 , fontweight='bold')
    ...
    axs[1, 0].set_xlabel("Time (ns)",fontsize=16 , fontweight='bold')
    ...
    axs[1, 1].set_xlabel("Time (ns)",fontsize=16 , fontweight='bold')
